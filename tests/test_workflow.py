...
def test_event_includes_tracestate_when_present(envelope) -> None:
    ...
    with patch(
        ...
        result = WorkflowOrchestrator(SuccessfulService(), envelope.repo).execute(
            envelope_with_tracestate
        )
